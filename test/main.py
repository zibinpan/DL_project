...
paths.append(os.path.dirname(path.dirname(__file__))+'\\Algorithms')
paths.append(os.path.dirname(path.dirname(__file__))+'\\MyProblem')
paths.append(os.path.dirname(path.dirname(__file__)))

from moea_GNN_MOEA_templet import moea_GNN_MOEA_templet
...
if __name__ == '__main__':
    ...
    """===============================算法参数设置=============================="""
    myAlgorithm = moea_NSGEA2_archive_templet(problem, population)  # 实例化一个算法模板对象
    # myAlgorithm = ea.moea_NSGA2_archive_templet(problem, population)
    myAlgorithm.complicated_PS = True
